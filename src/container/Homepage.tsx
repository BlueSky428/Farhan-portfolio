...
const HomePage: FC = () => {
    return (
        <div className="w-full max-w-7xl flex flex-col justify-start items-center lg:mt-56 md:mt-52 sm:mt-36 mt-32">
            <div className="w-full grid lg:grid-cols-[55%_45%] md:grid-cols-[50%_50%] sm:grid-cols-1 grid-cols-1">
                <div className="flex flex-col justify-start items-start px-6">
                    <div className="flex flex-wrap justify-start items-center">
                        <h1 className="text-4xl text-white font-bold tracking-wider lg:leading-relaxed"
                            style={{ "fontFamily": "cursive" }}>Concierge products for customers, Perfect global
                            remote development support</h1>
                    </div>
                    <div className="flex flex-wrap justify-start items-center mt-8">
                        <p className="mt-2 mb-6 text-white text-lg font-medium">
                            Customers: Wherever you are, Day or Night, Whenever you need me, Just contact me. I'll run
                            right away.
                        </p>
                    </div>
                    <SocialLinks />
                    ...
                    <svg viewBox="0 0 1273 906" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g>
                            <path className="path"
                                ...
                                stroke="url(#paint-linear)" strokeOpacity="0.6" strokeWidth="2"></path>
                        </g>
                        <path
